        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button disabled={note.etitle.length<3||note.edescription.length<1} onClick={()=>{handleClick();props.showAlert("Note Upadated ", "success")} } type="button" className="btn btn-primary">Update Note</button>
            </div>
          </div>
        </div>
      </div>
